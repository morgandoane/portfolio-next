...
/**
 * Images in public/energy/: desktop-hero, bluelines, energy-extraction,
 * energy-distribution, energy-map-tablet, energy-map-phone, energy-map-boston.
 */
...
export default function EnergyMapPage() {
  return (
    <div className="min-h-svh">
      <div className="mx-auto max-w-6xl border-x border-border">
        ...
        <header className="border-b border-border px-6 py-6 sm:px-8">
          <div className="flex items-center justify-between gap-4">
            ...
            <h1 className="text-lg font-semibold sm:text-xl">US Energy Map</h1>
            <span className="text-right text-sm text-muted-foreground">
              Academic Studio Project - 2023
            </span>
          </div>
        </header>

        {/* Hero - centered text + image within boundaries */}
        <section className="flex flex-col gap-6 px-6 pb-16 sm:px-8">
          <h2 className="mt-16 text-center text-4xl font-medium sm:text-5xl">
            The US Energy Map makes the grid visible, compelling, and
            understandable.
          </h2>
          <div className="mb-16 flex flex-wrap justify-center gap-x-6 gap-y-1 text-xs text-muted-foreground">
            <span>
              <strong className="text-foreground">Scope:</strong> Academic,
              Individual
            </span>
            <span>
              <strong className="text-foreground">Toolkit:</strong> Data
              Modeling, Next.js, Mapbox, TypeScript, Tailwind, Vercel
            </span>
            <span>
              <strong className="text-foreground">Date:</strong> Fall 2023
            </span>
          </div>
      ...
      <div className="mx-auto max-w-6xl border-x border-t border-border">
        {/* Context - image left, text right */}
        <section className="flex flex-col gap-6 px-6 py-16 sm:px-8 md:flex-row md:items-start md:gap-8">
          ...
          <div className="flex min-w-0 flex-1 flex-col gap-4 text-sm leading-loose text-muted-foreground md:flex-1">
            <p>
      ...
      <div className="mx-auto max-w-6xl border-x border-t border-border">
        {/* Outcome + Feature combined */}
        <section className="flex flex-col gap-8 px-6 py-16 sm:px-8 lg:flex-row lg:items-start lg:gap-12">
          <div className="flex min-w-0 flex-1 flex-col gap-4 text-sm leading-loose text-muted-foreground lg:flex-1 lg:basis-0">
            <h3 className="text-2xl font-medium text-foreground sm:text-3xl">
              The US Energy Map is a tool that helps users understand the scale
              of the grid and their position within it.
            </h3>
            <p>
              ...
              given area. Users can search for a location, then isolate
              particular energy production methods. Vertical extrusions encode
              plant capacity (height = megawatts); color encodes energy type.
              The vasculature represents electricity flow from plants into the
              grid.
            </p>
            <p>
      ...
      <div className="mx-auto max-w-6xl border-x border-t border-border">
        ...
        <section className="px-6 py-16 sm:px-8">
          ...
          <ol className="list-inside list-decimal space-y-3 text-sm leading-loose text-muted-foreground">
            <li>
              The vast majority of human systems simply cannot exist without the
              energy system.
            </li>
            <li>
              Decarbonization is only part of the challenge. Resilient,
              flexible, equitable distribution matters.
            </li>
            <li>
              Renewable energy is full of contradictions and paradox. While less
              fuel intensive, it is more materially intensive on a myriad of
              mined earth resources.
            </li>
            <li>
              Navigating these challenges requires not only technological
              innovation but also a deep consideration of social, economic, and
              environmental impact, ensuring that our journey towards
              sustainable energy benefits all aspects of society.
            </li>
          </ol>
        </section>
      </div>
